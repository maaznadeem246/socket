...
// Cli Help
//
export constexpr auto gHelpText = R"TEXT(
ssc v{{ssc_version}}
...
export constexpr auto gHelpTextBuild = R"TEXT(
ssc v{{ssc_version}}
...
export constexpr auto gHelpTextListDevices = R"TEXT(
ssc v{{ssc_version}}
...
export constexpr auto gHelpTextInit = R"TEXT(
ssc v{{ssc_version}}
...
export constexpr auto gHelpTextInstallApp = R"TEXT(
ssc v{{ssc_version}}
...
export constexpr auto gHelpTextPrintBuildDir = R"TEXT(
ssc v{{ssc_version}}
...
export constexpr auto gHelpTextRun = R"TEXT(
ssc v{{ssc_version}}
...
export constexpr auto gHelloWorld = R"HTML(
...
// Darwin config
//
export constexpr auto gPListInfo = R"XML(<?xml version="1.0" encoding="UTF-8"?>
...
// Credits
export constexpr auto gCredits = R"HTML(
  <p style="font-family: -apple-system; font-size: small; color: FieldText;">
    Built with ssc v{{ssc_version}}
  </p>
)HTML";

export constexpr auto DEFAULT_ANDROID_ACTIVITY_NAME = ".MainWebViewActivity";

//
// Android Manifest
//
export constexpr auto gAndroidManifest = R"XML(
...
// Linux config
//
export constexpr auto gDestkopManifest = R"INI(
[Desktop Entry]
Encoding=UTF-8
Version=v{{version}}
Name={{name}}
...
export constexpr auto gDebianManifest = R"DEB(Package: {{deb_name}}
Version: {{version}}
Architecture: amd64
...
// Windows config
//
export constexpr auto gWindowsAppManifest = R"XML(<?xml version="1.0" encoding="utf-8"?>
<Package
...
//
export constexpr auto gXCodeProject = R"ASCII(// !$*UTF8*$!
{
...
// Template generated by XCode.
//
export constexpr auto gXCodeExportOptions = R"XML(<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
  <key>method</key>
...
export constexpr auto gXCodePlist = R"XML(<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
  <key>CFBundleIdentifier</key>
...
export constexpr auto gXcodeEntitlements = R"XML(<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
<dict>
...
//
export constexpr auto gGradleBuild = R"GROOVY(
buildscript {
...
//
export constexpr auto gGradleBuildForSource = R"GROOVY(
...
//
export constexpr auto gGradleSettings = R"GROOVY(
...
//
export constexpr auto gGradleProperties = R"GRADLE(
...
//
export constexpr auto gAndroidMakefile = R"MAKE(
...
//
export constexpr auto gAndroidApplicationMakefile = R"MAKE(
...
//
export constexpr auto gProGuardRules = R"PGR(
...
//
export constexpr auto gAndroidLayoutWebviewActivity = R"XML(
<?xml version="1.0" encoding="utf-8"?>
<WebView
  xmlns:android="http://schemas.android.com/apk/res/android"
...
export constexpr auto gAndroidValuesStrings = R"XML(
<resources>
...
// XCode Build Config
//
export constexpr auto gXCodeScheme = R"XML(<?xml version="1.0" encoding="UTF-8"?>
<Scheme
...
export constexpr auto gStoryboardLaunchScreen = R"XML(<?xml version="1.0" encoding="UTF-8" standalone="no"?>
...
export constexpr auto gDefaultConfig = R"CONFIG(
#
...
export constexpr auto gDefaultGitignore = R"GITIGNORE(
# Logs
logs
*.log
npm-debug.log*
